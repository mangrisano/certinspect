...
| Discovery          | Enumerate a domain's certificates from Certificate Transparency logs (crt.sh) and inspect each host, surfacing forgotten or shadow certificates (`--discover`)                                                                                                                                                                                                                                                                                                                                                            |
